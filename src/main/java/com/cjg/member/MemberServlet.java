...
public class MemberServlet extends HttpServlet {
	...
	private void doHandle(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		out.print("<html><body>");
		out.print("<table border=1><tr align='center' bgcoor='lightgreen'>");
		...
		for(int i = 0; i<list.size(); i++) {
			...
			out.print("<tr><td>"+id+"</td><td>"+pwd+"</td><td>"+name+"</td><td>"+email+"</td><td>"+joinDate+"</td><td>"+"<a href='/member3?command=delMember&id="+id+"'> 삭제 </a></td></tr>");
		}
